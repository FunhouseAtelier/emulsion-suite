...
const MOCK_REVIEWS: Record<string, Review[]> = {
  ...
  "3": [
    { author: "Frank", rating: 5, text: "Surprisingly versatile." },
  ],
};
...
export default function ReviewCarousel({ productId }: ReviewCarouselProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: "0.5rem", color: "#f59e0b", fontSize: "1.25rem" }}>
        <Stars rating={review.rating} />
      </div>
      <p style={{ margin: "0 0 0.75rem" }}>"{review.text}"</p>
      <p style={{ margin: 0, fontSize: "0.875rem", color: "#6b7280" }}>— {review.author}</p>
